...
?>
        ...
        <ul class="nav menu">
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                <em class="fa fa-navicon">&nbsp;</em>Type Expenses <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
                <ul class="children collapse" id="sub-item-1">
                    <li><a class="" href="type_expense.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Add Expenses Type
                    </a></li>
                    <li><a class="" href="type_manage.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Manage Type
                    </a></li>
  ...
  <li class="parent "><a data-toggle="collapse" href="#sub-item-3">
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-4">
                <em class="fa fa-navicon">&nbsp;</em>PaymentType <span data-toggle="collapse" href="#sub-item-4" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
                <ul class="children collapse" id="sub-item-4">
                    <li><a class="" href="add_paymentType.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Add PaymentType
                    </a></li>
                    <li><a class="" href="manage_paymentType.php">
